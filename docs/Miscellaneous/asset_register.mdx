...
[Link to Asset Register](https://docs.google.com/spreadsheets/d/1203h5lg9okgDQaSqBJCMiNCaxUPnSv6WQC-AGJ_CoJo/edit#gid=0)

# Asset Register

This document holds the finalised -ready for public consumption- sales and marketing assets.
The Asset Register will point to the latest version and prevent us from showing out of date and potentially misleading information to our prospects and customers.

### Fixed Assets
Fixed assets are changed infrequently by a smaller group of people and are controlled by a version control system.
...
If you have built some new content into a customised version that you would like to see in the Master or a variation of the Master then let marketing know and we can incorporate the changes or generate a new variation. This will help us all in the long run as all improvements will merge back into a single Master file.

E.g. Decks, event invitations.
